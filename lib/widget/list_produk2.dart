...
class AllnewLstview2 extends StatefulWidget {
  final String namaData;

  const AllnewLstview2({
    required this.namaData,
  });

  @override
  State<AllnewLstview2> createState() => _AllnewLstview2State();
}

class _AllnewLstview2State extends State<AllnewLstview2> {
